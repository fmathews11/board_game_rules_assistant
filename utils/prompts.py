...
GAME_IDENTIFIER_PROMPT = """
        ...
        If no specific board game is mentioned, or if the message is a follow-up that doesn't restate the game, 
        output 'None'.
...
QA_PROMPT_TEMPLATE = """
       ...
       --- HOW TO ANSWER --
        ...
        - If the answer is not found in the manual or any additional context, or if the information is insufficient to 
          fully answer the question, clearly state this.
        - If, AND ONLY IF, the game is 'spirit_island' and you have determined that the manual and any additional 
          context do not provide sufficient information:
          1. Identify the SPECIFIC pieces of information that are missing (e.g., specific card details, specific rule 
            clarifications).
          2. Include the exact phrase "[TAVILY_SEARCH_RECOMMENDED_FOR_SPIRIT_ISLAND]" followed by the specific missing 
        ...
        - DO NOT include phrases such as "based on the provided manual" or "based on the context" unless you are 
          explaining why the manual is insufficient.
        - Be as verbose as necessary. First provide a detailed explanation of the answer 
          (or why the manual is insufficient), then provide a short summary.
...
## Answer guidelines
 ...
 - If the context does not contain sufficient information to fully answer the question, include the exact phrase 
  "{INSUFFICIENT_SEARCH_RESULTS_MARKER}" at the end of your answer.
